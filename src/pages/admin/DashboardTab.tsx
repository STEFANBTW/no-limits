...
export const DashboardTab = () => {
  ...
  return (
    <div className="pt-28 pb-12 px-6 md:px-12 flex-1 overflow-y-auto">
      {/* Header Section */}
      <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h2 className="text-4xl font-headline text-on-surface mb-2">Atelier Command Center</h2>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="col-span-1 xl:col-span-8 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Metric Card 1 */}
            <div className="bg-surface-container rounded-xl p-8 hover:bg-surface-container-high transition-colors duration-500 group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span className="material-symbols-outlined text-6xl text-primary">pending_actions</span>
              </div>
              <h3 className="font-label text-xs uppercase tracking-widest text-secondary mb-4">Pending Commissions</h3>
              <div className="font-headline text-5xl text-on-surface mb-2">{pendingOrders}</div>
            ...
            <div className="bg-surface-container rounded-xl p-8 hover:bg-surface-container-high transition-colors duration-500 group relative overflow-hidden">
              ...
              <h3 className="font-label text-xs uppercase tracking-widest text-secondary mb-4">Total Revenue</h3>
              <div className="font-headline text-[2.5rem] text-on-surface mb-2">₦{totalRevenue.toLocaleString()}</div>
              <div className="flex items-center gap-2 text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-xs text-primary">arrow_upward</span>
            ...
            <div className="bg-surface-container rounded-xl p-8 hover:bg-surface-container-high transition-colors duration-500 group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span className="material-symbols-outlined text-6xl text-primary">chair</span>
              </div>
              <h3 className="font-label text-xs uppercase tracking-widest text-secondary mb-4">Products</h3>
              <div className="font-headline text-5xl text-on-surface mb-2">{products.length}</div>
              <div className="flex items-center gap-2 text-sm text-on-surface-variant">
          ...
          <div className="bg-surface-container-low border border-outline-variant/10 rounded-xl p-8 h-96 relative flex flex-col">
            <div className="flex justify-between items-center mb-8">
              <h3 className="font-headline text-2xl text-on-surface">Collection Traffic ("Worlds")</h3>
              <button className="text-xs font-label uppercase tracking-widest text-primary hover:text-primary-dim transition-colors">View Report</button>
            </div>
            {/* Abstracted Chart Representation */}
            <div className="flex-1 flex items-end gap-6 pl-4 border-l border-outline-variant/15 pb-4 border-b border-outline-variant/15 overflow-x-auto">
              <div className="flex flex-col items-center gap-3 w-full min-w-[60px] group">
                ...
                <span className="font-label text-[10px] text-secondary tracking-widest">SEATING</span>
              </div>
              <div className="flex flex-col items-center gap-3 w-full min-w-[60px] group">
                <div className="w-full bg-surface-container-high group-hover:bg-primary/20 transition-colors h-[45%] rounded-t-sm relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-transparent to-primary/10 rounded-t-sm"></div>
                </div>
                <span className="font-label text-[10px] text-secondary tracking-widest">TABLES</span>
              </div>
              <div className="flex flex-col items-center gap-3 w-full min-w-[60px] group">
                ...
                <span className="font-label text-[10px] text-primary font-medium tracking-widest">VANGUARD</span>
              </div>
              <div className="flex flex-col items-center gap-3 w-full min-w-[60px] group">
                <div className="w-full bg-surface-container-high group-hover:bg-primary/20 transition-colors h-[30%] rounded-t-sm relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-transparent to-primary/10 rounded-t-sm"></div>
                </div>
                <span className="font-label text-[10px] text-secondary tracking-widest">LIGHTING</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:col-span-4 flex flex-col gap-8">
          ...
          <div className="bg-surface-container-low border border-outline-variant/10 rounded-xl p-8">
            <h3 className="font-headline text-xl text-on-surface mb-6">Quick Actions</h3>
          ...
          <div className="bg-surface-container rounded-xl p-8 flex-1 flex flex-col shadow-lg border border-outline-variant/5">
            <h3 className="font-headline text-xl text-on-surface mb-8">Recent Activity</h3>
